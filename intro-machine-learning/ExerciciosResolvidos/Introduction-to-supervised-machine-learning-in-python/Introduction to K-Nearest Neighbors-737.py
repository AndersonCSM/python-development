...
banking_df["y"]
banking_df["y"] = banking_df["y"].str.replace("yes", "1").str.replace("no", "0")
banking_df["y"] = pd.to_numeric(banking_df["y"])
...
X_train["age"] = X_train["age"].apply(lambda x: (x - X_train["age"].min())/(X_train["age"].max() - X_train["age"].min()))

X_train["campaign"] = X_train["campaign"].apply(lambda x: (x - X_train["campaign"].min())/(X_train["campaign"].max() - X_train["campaign"].min()))
